    ...
    <section className=" bg-light py-20">
      <div className=" container mx-auto px-4">
        <div className=" items-center justify-between lg:flex">
          <div className=" mb-10 lg:mb-0 lg:w-4/12 lg:pr-24">
          ...
          <div className=" lg:w-8/12">
            <div className=" w-full items-end gap-0 md:flex md:gap-6">
              ...
              <div className=" md:w-6/12">
                <div className=" mb-6 hidden h-16 w-16 rounded-full bg-greenLight md:block"></div>
                <div className=" mb-6 w-full rounded-lg bg-white p-7">
                  <div className="mb-4 flex items-center gap-4">
                    <div className=" relative">
                      <Image
